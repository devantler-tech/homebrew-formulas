class Ksail < Formula
  ...
  url "https://github.com/devantler-tech/ksail/releases/download/v2.31.88/ksail.tar.gz"
  sha256 "1b32298f50cd0e11ca2504baad04e487b5afa89704348773d375a43c43930ed3"
  license "Apache-2.0"
