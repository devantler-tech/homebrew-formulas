class Ksail < Formula
  ...
  url "https://github.com/devantler-tech/ksail/releases/download/v2.31.67/ksail.tar.gz"
  sha256 "d2d752502f2f25265209db4b799b64c6f35fee41e502ea0a1100a61886d6e9ca"
  license "Apache-2.0"
