class Ksail < Formula
  ...
  url "https://github.com/devantler-tech/ksail/releases/download/v2.31.95/ksail.tar.gz"
  sha256 "b1e9eafebec18ce30ff5f2191a833d8c018291926600962223cfe15efa72b57f"
  license "Apache-2.0"
