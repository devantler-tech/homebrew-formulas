class Ksail < Formula
  ...
  url "https://github.com/devantler-tech/ksail/releases/download/v2.30.67/ksail.tar.gz"
  sha256 "5a23e589426570a09455f74a0c44dfba760c1019dabddc5d3fceb85ee93c68e4"
  license "Apache-2.0"
