class Ksail < Formula
  ...
  url "https://github.com/devantler-tech/ksail/releases/download/v2.31.128/ksail.tar.gz"
  sha256 "af391403b0a2e4f231bf8413bad07647d646ece309dbbefeb7e6f0d6f85e2b8f"
  license "Apache-2.0"
