class Ksail < Formula
  ...
  url "https://github.com/devantler-tech/ksail/releases/download/v3.1.60/ksail.tar.gz"
  sha256 "aeab4e1e1b00022308eb9292a60a2054dc69db190f36c75d16b1946c7e28cde5"
  license "Apache-2.0"
