class Ksail < Formula
  ...
  url "https://github.com/devantler-tech/ksail/releases/download/v2.20.1/ksail.tar.gz"
  sha256 "9167b79b4494721a10ce64ff15e2353239db2d9e6e4bb87ff955b413863a7c6b"
  license "Apache-2.0"
