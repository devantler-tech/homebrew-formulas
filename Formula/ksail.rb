class Ksail < Formula
  ...
  url "https://github.com/devantler-tech/ksail/releases/download/v3.0.3/ksail.tar.gz"
  sha256 "c586d69b286619775e90870862f1ebc5a570230edeb8c7613aba67ef9563d5b3"
  license "Apache-2.0"
