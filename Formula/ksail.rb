class Ksail < Formula
  ...
  url "https://github.com/devantler-tech/ksail/releases/download/v2.31.98/ksail.tar.gz"
  sha256 "cd0db9079e82dfad7e84ed7759e1019b25952c5721f1e7ddcc6b5625d44e258a"
  license "Apache-2.0"
